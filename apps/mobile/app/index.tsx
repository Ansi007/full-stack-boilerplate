      ...
      <View style={styles.safeArea}>
        <View style={styles.content}>
          ...
          <View style={styles.inputSection}>
            ...
            />
            <TouchableOpacity
              style={[styles.button, (!content.trim() || createCrud.isPending) && styles.buttonDisabled]}
          ...
          <View style={styles.listContainer}>
            {crudList.isLoading ? (
              ...
              <View style={styles.emptyText}>
                <Text style={styles.emptyTextContent}>No items yet. Add one to get started!</Text>
              </View>
            )}
          </View>
        </View>
